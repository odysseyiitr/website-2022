  ...
  return (
    <div className="repodialogue">
      <div className="scroll">
        ...
        <Repo Card={{ "tag": "easy", "claim": true, "mentor": "mayank", "repoName": "Rootex", "issueTitle": "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor", 'assignee': "jai_ho" }} />
        <Repo Card={{ "tag": "medium", "claim": true, "mentor": "mayank", "repoName": "Rootex","issueTitle": "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor" }} />
